CREATE TABLE IF NOT EXISTS Utente (Matricola VARCHAR(15) NOT NULL PRIMARY KEY, Password VARCHAR(250) NOT NULL, Nome VARCHAR(25) NOT NULL, Cognome VARCHAR(25) NOT NULL, Email VARCHAR(50) NOT NULL UNIQUE, DataNascita DATE NOT NULL, Ruolo VARCHAR(15) NOT NULL, Sesso VARCHAR(5) NOT NULL, Foto VARCHAR(250));

CREATE TABLE IF NOT EXISTS Aula (IdAula VARCHAR(4) NOT NULL PRIMARY KEY, Capienza INT(11) NOT NULL, Caratteristiche TEXT);
